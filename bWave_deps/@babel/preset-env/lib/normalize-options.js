...
export const default = normalizeOptions;
export const validateUseBuiltInsOption = exports.validateModulesOption = exports.checkDuplicateIncludeExcludes = exports.normalizePluginName = void 0;

import _data from 'core-js-compat/data.json';
import _semver from 'semver';
import _corejs2BuiltIns from '@babel/compat-data/corejs2-built-ins';
...
export { normalizeCoreJSOption, normalizePluginName, checkDuplicateIncludeExcludes, validateModulesOption, validateUseBuiltInsOption };
