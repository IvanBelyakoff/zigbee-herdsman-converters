...
// const definition_1 = require("./dataType");
import * as buffalo_1 from "./buffalo.mjs";
import * as definition_1 from "./dataType.mjs";
...
class BuffaloZcl extends buffalo_1.Buffalo {
    ...
    read(type, options) {
        console.log("BuffaloZcl.read type:", type, JSON.stringify(options))
