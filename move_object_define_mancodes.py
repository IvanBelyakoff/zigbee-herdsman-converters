...
# parser.add_argument("text_to_move", help="Text to move", default=r'''
# Object.defineProperty(exports, "__esModule", {
#   value: true
# });
# ''')
# parser.add_argument("text_dest_position", help="Position of the text to insert after", default=r'var exports = ')
  ...
  value: true
    ...
    with fdopen(fh,'w') as new_file:
        with open(file_path, 'rt') as old_file:
            ...
            if m is not None:
                pos = all_text.find(destinationPosText, m.span()[1] + len(textToMove))
