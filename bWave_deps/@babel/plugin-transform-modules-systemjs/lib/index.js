...
export { getExportSpecifierName };
export const default = void 0;

import _helperPluginUtils from '@babel/helper-plugin-utils';
import _helperHoistVariables from '@babel/helper-hoist-variables';
import _core from '@babel/core';
import _utils from 'babel-plugin-dynamic-import-node/utils';
import _helperModuleTransforms from '@babel/helper-module-transforms';
