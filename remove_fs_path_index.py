...
def replace(file_path):
    ...
    with fdopen(fh,'w') as new_file:
        with open(file_path, 'rt') as old_file:
            ...
            removeStringList = ["const fs = require('fs');", "const path = require('path')"];
            skipNext2LinesStr = 'const devicesPath = path.join'
            skipCounter = 0
...
if os.path.isdir(args.path):
    ...
    raise Exception("remove_fs_path_index", "No file or directory:" + args.path)
