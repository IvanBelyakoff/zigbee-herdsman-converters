...
export const assumptionsNames = void 0;

import _plugin from '../plugin';
import _removed from './removed';
import _optionAssertions from './option-assertions';
...
export { validate, checkNoUnwrappedItemOptionPairs, assumptionsNames };
