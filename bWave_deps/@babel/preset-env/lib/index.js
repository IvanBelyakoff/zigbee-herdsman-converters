...
export const default = exports.getPolyfillPlugins = exports.getModulesPluginNames = exports.transformIncludesAndExcludes = void 0;

import _semver from 'semver';
import _debug from './debug';
import _getOptionSpecificExcludes from './get-option-specific-excludes';
import _filterItems from './filter-items';
import _moduleTransformations from './module-transformations';
import _normalizeOptions from './normalize-options';
import _shippedProposals from '../data/shipped-proposals';
import _pluginsCompatData from './plugins-compat-data';
import _overlappingPlugins from '@babel/compat-data/overlapping-plugins';
import _regenerator from './polyfills/regenerator';
import _babelPolyfill from './polyfills/babel-polyfill';
import _babelPluginPolyfillCorejs from 'babel-plugin-polyfill-corejs2';
import _babelPluginPolyfillCorejs2 from 'babel-plugin-polyfill-corejs3';
import _babelPluginPolyfillRegenerator from 'babel-plugin-polyfill-regenerator';
...
export { isPluginRequired, transformIncludesAndExcludes, getModulesPluginNames, getPolyfillPlugins };
